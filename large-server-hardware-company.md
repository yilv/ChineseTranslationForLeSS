...
## BIOS自下而上的扩大 {#bios-expanded-from-the-bottom-up}
...
# BIOS与LeSS规则的比对 {#bios-alignment-to-less-rules}
...
* <span style="color:navy">在扩展组件团队中改进的员工**协作、投入和学习**</span>
    ...
    + 后续的影响：
        - 用理查德·哈克曼（Richard Hackman）《高效团队：领导团队走向成功的5大黄金法则》书中的术语来说，BIOS团队是*真正的团队*，而非松散协作的一群个体。每个团队都有一个清晰的团队*任务*，清晰的*边界*，清晰指定的管理他们自己工作流程的*权力*，以及成员的*稳定性*。
