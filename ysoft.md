...
## 0. 在LeSS实施之前 Before the LeSS Adoption

### 0.1 背景 Context

在瀑布式产品研发之后，Y Soft开始尝试“敏捷产品交付”，然而这只是一个他们新工作方式的名字而已，和敏捷与产品交付几乎没有关系。他们重组了9个*组件*团队，每个团队设置一个架构师作为“产品负责人”！至少需要4个“Sprints”才能交付一个特性，而且没有任何团队可以独立交付特性。说明一下，这并不是真正的“Sprints”，由于是组件团队（非特性团队），“Sprint”的产出物往往是一些组件任务，不是完整的特性，这并不符合我们的初衷：每个Sprint输出一个可交付的产品。各种不同的角色（如项目经理、销售、市场营销）都可以直接与研发沟通，打断他们当前的工作，并要求他们着手新功能的开发。为了解决在交付客户特性功能方面遇到的挑战，Y Soft公司的研发副总裁（VP）成立了一个产品管理委员会。他们负责产品级的决策，决定团队要开发的新特性功能。这导致了一个管理过度、几乎没有任何适应性的流程，并且对于正在发生的事情也没有增加多少透明度。此外，那些想要实现某特性或变更的人利用他们与团队经理和开发者的关系，来达成他们的目标，完全超越流程之外。这证明了*简单办法*（成立产品委员会）*往往会“自食其果”*，甚至有可能让事情变得更糟。
...
第一次尝试特性团队是在产品的扫描领域，这是一个对客户来讲比较直观的业务领域。2个组件团队和来自测试与发布的人员共同组成了一个特性团队，并开始更接近Scrum的尝试。虽然没有按照Scrum的隐性要求*进行大规模的组织变革*，但也实施了一些细微的调整，使团队能够以这种方式工作。这也驱动我们雇佣了第一位Scrum Master，帮助推动变革。该特性团队首次尝试增量迭代的开发模式，每1到2个Sprint给客户做一次产品增量交付。这让团队可以和客户更紧密的合作。在开发人员和客户之间不再有中间人的角色，所以可以更直接快速获得客户反馈，这种协作模式可以促进团队交付客户真正想要的需求，避免构建“臆想”的功能。并且促进通过学习来不断适配的模式。在特性团队的尝试过程中，研发部门的产品总监（也是SAFEQ产品下全部团队主管的领导）也做了一些*微小*的管理组织架构变革：他指定了1个经理负责整个特性团队，而不再是3个经理（2个组件团队经理和1个测试经理）。这是管理层逐步向支持性角色转变的首次尝试。同时，这次实验还取消了团队主管角色。
...
扫描试点后续被认为是整个研发组织的“行事之道”。但是，由于当前的组织架构，不同的领导和专家依旧希望保持他们的权利现状，导致一些*关键*因素被忽略，比如真正的跨组件、跨职能团队。简而言之，相比真正的特性团队，他们实施了一系列琐碎的实践变革，而非深度的组织设计变革，但只有深度组织变革才能在适应性、前置时间和客户满意这些维度带来较大收益。因此，通过变革他们只收获了一些较小的改进，所以Y Soft仍旧在寻找更好的模式去应对挑战。
...
在LeSS实施前，Y Soft在小范围尝试了一些组织设计元素实验，这些尝试并未对更大的组织产生影响。这些组织设计元素对敏捷有一定积极正面的作用，但是在没有必要的*大规模*组织设计变革做支撑的前提下，不会带来大的影响改变。总结一下，单团队单实验涉及的组织设计元素包括： 
* LeSS规则：每个团队是 (1) 自管理的，（2） 跨职能的，（3） 同在一地的，（4）长期的
* LeSS实验：尝试...通过消除“未完成”的工作来消除“未完成”的单元
* LeSS实验：尝试...工作再设计
...
全部这些组织设计元素都是有一定局限性的，因为单团队的 *外围组织* 并*未发生改变*。相比之前，团队变得更加跨职能了，成员都在同一地，且更加长期稳定。但是，自管理是很难的，因为他们在没有帮助的前提下，无法独立交付工作增量。而且他们只能从他们有限的视角出发，去端到端的交付以客户为中心的特性，而不是从整个产品的视角。即便如此，从他们的小视角来看，之前被组织在“未完成”单元的工作再设计和功能整合，确实也带来了一些微小的收益。更多关于组织设计元素的更多说明请参考第一个组织设计实验的 [组织设计元素章节](#125-organizational-design-elements)
...
第一个特性团队的尝试以及推广的失败，导致Y Soft的人员开始寻找外部的信息资料，以发现推进Scrum的正确之路。他们初尝了Scrum的益处，但是在没有*必要的组织变革*支撑下，他们无法整合收益。 他们通过Google搜索找到了LeSS官网，并参加了当地的敏捷社区和活动，这引发了他们对LeSS的真正兴趣。特别是Jürgen De Smet在2016年布拉格敏捷大会上的演讲 [“组织是如何失控的”](https://youtu.be/QkGyVKl9CGE)，深深的吸引了他们。
...
在审视可行的LeSS实施方案时，Y Soft的研发人员意识到这是一场需要外部支持的变革。他们在2018年4月左右，联系了[Jürgen De Smet](https://less.works/profiles/jurgen-de-smet)，请求合作，这是基于他们在CLP中的积极体验。此外，他们给董事会提交了一份LeSS实施的预算提案，包括为什么要变革，以及可能的成功指标。董事会最终在2018年5月底通过了这项提案，这样同年6月，LeSS实施得以正式启动。这也触发了*第一个重要组织设计变革*的准备工作。
...
## 1. 实验1 组织设计：单产品特性团队 Experiment 1 Organizational Design: A Single product with feature teams

### 1.1 背景 Context

产品总监决定实施LeSS，计划在未来一个时间，组织一场为期四天的活动，以遵循LeSS实施指南*从这里开始*的步骤建议，确保一个合适的开始。他们把这称之为“LeSS向前翻转”活动。基于 *“深而窄”优于“浅而宽”* 的LeSS实施原则，产品总监与市场团队（研发之外）锁定了一款具体的产品和清晰的范围，从而可以有效践行“深而窄”，专注聚焦。通过为期4天的活动，组织一次性完成了 *结构变革（组织和产品）*。
...
Y Soft高管选择Co-Learning咨询公司（现在名为Simplification Officers）作为LeSS实施的合作伙伴。Y Soft内部LeSS支持者（Scrum Master，开发人员和部分中层管理者）主动承担了LeSS实施准备工作和工作坊的组织活动，他们和外部咨询师伙伴一起梳理现状与挑战，学习探讨必要的变革（参考下面章节）。通过这种方式，内部人员成为变革的真正主人，这也是获得变革成功和能真正主导变革的关键。而外部知识只被用作指导和知识库。
...
#### 1.2.1 LeSS实施准备 Preparation for the LeSS adoption

准备工作以从不同视角分析Y Soft研发背景开始，包括组织、工作流、代码的技术健康度。远程准备的目标是了解Y Soft现状，获取对Y Soft和Co-Learning（LeSS实施的合作伙伴）更深入的理解，并一起学习确定下一步任务与方向。通过执行下述活动，来分析现状：

* 通过内部使用工具的分析做组织级评价，如Confluence，ERP。
* 通过分析代码，构建部署计划，分支管理策略和架构文档，来评价技术健康度。
...
技术健康度评估被用于和开发人员一起验证并学习如何改进。例如，开发团队吸取的一个学习点是，曾经只有个别人员具备的知识点（特定组件或技术），要确保在团队自设计过程中能有效传播，从而让全部团队成员都有机会学习到这类知识，减少技能瓶颈。
...
在LeSS实施准备过程中，下述初始评估结果被指出：

* 对于相对小的组织，存在较多的管理层级
* 没有明确的产品负责人 - 有团队PO，架构师和项目经理，然而这些角色在Scrum中是不存在的。
* 长期处于“救火”状态，解决突发紧急情况，追求表面的完成状态。
* Jira工作流中存在很多状态与员工实际工作不匹配
* 大约有75个明确的待办
* 总共898个构建计划，最长构建时间25小时，50个构建计划连续失败。
* 发布很困难，需要很多时间，因为每个团队聚焦在一个具体组件的具体模块上。
...
这些评估结果在工作坊中被验证确认，并作为为期4天的工作坊的输入。
...
更多关于LeSS实施准备的介绍，请参考[附录B](#appendix-b-preparation-to-the-4-day-events-that-kicked-off-the-less-adoption).
...
基于前期准备的结果，按照Toyota Kata方法，掀起了一场组织改进Kata活动。设定的方向与挑战是，在为期4天的活动之后，找到最适合开启LeSS的组织结构。
...
一个被选定的小组正在进行“Management3.0”的“搅局者游戏”，通过这个游戏设计未来的组织状态。他们挖掘不同的模式选项，选择喜欢的去进一步优化，并消除大多数（并非全部）不喜欢的选项。
...
在Y Soft，由VP和Scrum Master主导4天启动活动的准备。并没有因此专门成立一个变更小组，全部活动组织的职责都由志愿者承担。志愿者们每周同步2次进展，并讨论下一步工作计划。
...
活动之一是成立了社区（也称为“实践社区”），以便团队之间能够协作，实现共同设计和知识分享。LeSS指南*社区*就是为了重点解决跨团队事宜，比如技能、标准、工具和设计。推荐的社区包括设计/架构社区和测试社区，开发人员有时会被要求成立他们认为有用的社区，这会导致过多无实际作用的社区。
...
此外，外部支持也常被用于组织深度的技术工作坊。在事件风暴（Event Stroming）工作坊中，志愿者们把（技术）架构师拉向前与业务场景相链接。团队需要从聚焦组件转变为聚焦整个产品，而且这些洞见能够帮助团队更好的理解产品。另外，在专注逐步重构的内部代码静修（Code retreat）工作坊活动中，引入一些必要的工程实践，帮助团队向前发展。人们可以在他们团队内部使用工作坊中学到的知识。通过这种方式，实现了将全部组件集成为一个产品，包括支持，发布和其他活动。
...
#### 1.2.4 4天活动开启LeSS实施 The 4-day event starting the LeSS adoption

在2019年1月，组织了为期4天的启动活动。所有能参与的志愿者都会参加，包括产品负责人，管理层和其他一些支持角色。产品总监向大家介绍了LeSS变革的原因。
...
##### 第一天：初始的产品待办梳理 Day 1: initial Product Backlog Refinement (initial PBR)

作为初始产品待办梳理的第一步，产品负责人分享了产品愿景。LeSS指南*初始的产品待办梳理*目的是让团队充分理解即将要做的产品待办事项。这在实施LeSS的初期非常重要，因为通常现有的所谓“产品待办事项列表”遵循旧的组织结构，往往是基于模块或者组件的，而不是以客户为中心。在特性团队模式下，产品待办事项（PBI's）应聚焦客户，因此原“产品待办事项”会失效，但是它却仍可以作为初始产品待办梳理活动的关键输入。在众多说明初始PBR（产品待办梳理）非常重要的原因中，最关键的是通过PBR，能确保团队充分理解PBI（产品待办事项），而不仅仅由某个人或某个团队记录下每个PBI，并假设其他人都能正确理解这些PBI。
...
产品愿景是初始PBR（产品待办梳理）活动的起点，该活动应全员参与。工程师规划选定一个场所，大家以小组方式一起工作，平均每个待办事项约6个人。大家会进行多轮迭代讨论，每轮迭代后，彼此互相分享结果，这个过程有些类似LeSS Sprint评审市集（LeSS Sprint Review Bazaar），但仅仅是待办事项的分析，而并非完成功能的展示。在完成多轮迭代梳理后，大家分成小组，由“多人共同编写/更新文档”（Mob documenting），把梳理结果更新到Wiki和产品待办列表中。完成这个工作后，团队开始估算梳理好的产品待办事项。
...
##### 第二天： 创建完成的定义 & 自我设计团队 Day 2: Creating the Definition of Done & self-design the team

每个人都参与了“完成的定义”工作坊，从而建立起一个面向产品的统一的完成定义（DoD）。基于LeSS指南*创建完成的定义*，这需要在第一个Sprint开始前完成。参与者们重新分组，并借助LeSS指南*跨团队会议*的引导技术，整个团队通过“先发散后整合”模式，最终形成一份完成定义（DoD）。
...
在这之后，大家组织了一场“未完成项”工作坊，通过这个工作坊去探索每个Sprint能够完成哪些活动（在LeSS指南*创建完成的定义*之后）。人们将那些不在完成定义（DoD）中的活动 - 意味着团队无法完成这些活动 - 分配到各个小组中。每个团队梳理定义如何完成这类活动（何时，何地 & 做什么），从而识别出遗漏项，补充形成一个“完美”的DoD，能够满足产品交付客户的目标。在未来，团队将利用“未完成定义”去完善“完成定义”。这给了团队透明度，使他们知道需要和谁去紧密协作来完成什么。同时也给团队提供了如何处理（某种类型）“未完成”工作的洞见，以及未来改进完成定义（DoD）的机会。
...
然后，人们“焚烧”了他们的旧团队。大家先制作了当前团队的资料，以及当前团队的意义。然后他们真的焚烧了这些资料，作为对过去团队的告别，同时也表达了用全新心态去设计新团队的决心。
...
在这之后，“自我团队设计”工作坊开始了。LeSS实施原则之一*采用志愿者*模式，可以鼓励吸引人们参与，并让大家有被授权的感觉。最重要的一点是自我设计团队，也就是让大家自己决定未来团队是什么样子的。自我设计团队的标准包括：
* 团队位于在同一地点
* 团队规模在6到10人
* 能够尽可能多的独立交付PBI(产品待办事项)
* 团队成员能力和性格的多样性
...
在工作坊开始前，宣布只有希望成为团队成员的志愿者（遵循*采用志愿者*的实施原则）、Scrum Master和管理者们可以留在房间里，因为他们将是在新环境中一起工作的主要人员。其他人被要求离开。一些架构师离开了，因为他们不想成为团队一员。每个志愿者填写了一份模版“个人特征表”。这包括个人能力，技术能力和其他一些认为需要加入表格的重要信息。这个表格在后续的自我团队设计迭代中会频繁用到。经过三轮迭代后，全部团队成员至少对团队设置表示"可以"，这意味着初始团队已经确定形成了。
...
##### 第三天：团队协议 & 团队跟进 Day 3: Team agreements & follow-up with teams

团队以最后一轮自我设计迭代开启第三天的活动。在完成自我团队设计后，团队还需要开展一些工作来达成一致：
...
团队也能够在一组Scrum Master中选择一位Scrum Master（限制条件：相同地点）。在这之后，每个团队内部组织“完成/未完成”评审，从而了解自己能交付DoD定义的哪些部分，以及改进方向。
...
然后，参与人员共同讨论产品的运维支持类工作。除了客户需要的特性功能，还有一些其他类型的工作，问题或缺陷常有发生，而且经常是“突发”的和计划之外的。Y Soft设有一个支持部，专门负责一线、二线和三线的产品运维支持工作，直接服务客户。如果支持部遇到无法解决的客户问题，或者需要研发支持，他们就会给研发（即团队）创建四线运维事件。这些新成立的团队决定，每个Sprint由一个团队负责解决四线运维事件，与支持部（有时是客户）共同解决这些问题。这个团队就是LeSS指南*处理特殊事项*的快速响应团队，而且是轮换制的，从而实现了全部团队共同承担运维支持职责，并同时保持阶段性专注。由于原架构下的团队是组件制的，各团队各自处理这类支持事件，对大多数新团队来讲，这意味这他们没有足够的知识能力去处理全部的运维事件，因此大家都需要进一步学习。
...
##### 第四天：Sprint计划会 Day 4: Sprint Planning

在活动的最后一天，团队在新的设置下，按照LeSS指南*Sprint计划会-Part one*组织了他们的第一次Sprint计划会议1.Jürgen解释了Sprint计划的目的和指导原则。产品负责人以从产品视角的优先级说明开启了Sprint计划会。
...
每个团队分享了他们在下一个Sprint的可用时间安排（假期，会议等），以及他们需要完成的已经在进行中的工作。此外，他们也补充了必须要解决的缺陷。然后，团队在像“集市”一样的场景下，自己挑选PBI（产品待办事项），并和大家分享团队下一个Sprint的工作项选择与设计。这些PBI都是打印出来的，以便团队可以方便抓取选择，并和其他团队讨论哪些PBI会被选中。
...
下一步，每个团队独立地定制Sprint目标。然后，所有团队的Sprint目标被集合起来，大家对即将到来的Sprint整体目标沟通对齐。重要的是，与Scrum不同，LeSS并不强调统一的Sprint目标。当冲刺目标有用且存在自然且明确的总体目标时，应用冲刺目标是很好的做法。但是当没有一个自然且明确的总体目标时（比如，跨团队工作的异质性），最好还是不要硬性设置一个共同的Sprint目标。
...
在同一个房间内，每个团队选择他们想要做的PBI（打印好的），放属于他们自己团队空间的Sprint待办列表中（墙上的磁力白板）。在LeSS指南*多团队Sprint计划会-Part two*，强调所有团队应该在同一个房间内进行Spinrt计划会议-Part two，以便能够通过“直接沟通”或“直接讨论”的方式来与其他团队进行协作。
...
在团队成员查看其他团队选择时，按照最小化团队间依赖的指令原则，会将某些事项从一个团队转移到其他团队。在LeSS中，不存在依赖，因为每个特性团队都具备必要知识和能力去完成以客户为中心的端到端的特性。如果不能，期望团队能够学习获取所需的知识技能。由于团队是全新的，所以可能存在特性，没有团队具备端到端交付它的知识能力。在Sprint计划会的第二部分，团队间进行协作，讨论如何端到端的交付特性，如果需要的话，他们会借助其他团队的知识和技能，最好是通过主动学习这些知识技能来达成。通过这种方式消除了依赖，因为团队在同一时间一起完成了特性。从事后回顾的视角看，要求团队尽量减少依赖的指令可能会给团队带来错误的认知，因为重点应该放在通过与其他团队合作来学习和获取知识技能。通过简单协作来学习和完成特性，不应该被视为依赖。随着时间的推移，通过传递正确的信息，应该能够消除团队间存在依赖的错误感知。
...
在最后，所有参与者通过“斗舞”来庆祝为期4天活动的圆满结束。而且从那个时刻起，全部新团队将正式按照新的结构开始一起工作。
...
组织（OD）设计实验中，包含了简短的组织设计元素总结说明：

A summary and short elaboration of the OD-elements that were involved in the OD experiment:

* *LeSS规则: 使用真实的团队作为基本组织建设单元来构建组织。*

* *LeSS rule: Structure the organization using real teams as the basic organizational building block.*

产品是由团队创造的，而传统组织是围绕个人责任构建的。个人责任制不能促进达成协作顺畅的职能团队，因为这样的团队需要共同承担责任来实现他们的目标。这也是为什么围绕（实际）团队构建组织是重要的组织设计元素之一，同时也被纳入LeSS指南*构建基于团队的组织*。围绕团队构建组织会带来重要的影响。团队是工作的主要承担者，而非个人，也就是说在组织变革中个人不会被改变或资源化。这同时也意味着，工作首先会分到团队，而不是个人。作为结果，组织结构将保持（更加）稳定，不需要进行重构，从而避免了所有相关的负面后果。这些团队围绕客户价值来组建，而不是围绕子产品或者组织职能。很多组织按照职能来搭建，在这种情况下，影响是比较大的。在LeSS实施前，Y Soft实验过跨职能团队，但是未能通过这种方式改变其研发组织。从LeSS实施开始，团队就成为产品的基石，然而架构师和用户体验专家却是例外，在LeSS实施过程中，他们始终游离于团队之外。
...
作为前一个组织设计元素的推论，LeSS定义了“团队”的含义。一些对团队的理解并没有体现出基于团队的组织应该带来的好处。因此，团队是资管理的，跨职能的，同在一地的和长期的。此外（也许不是必须的），每个成员应该100%的时间都属于一个，而且是唯一一个团队。团队需要具备全面（职能的）能力去完成产品的交付（并且持续提升跨职能性）。如果你希望长期存在的团队关注他们作为一个团队如何协作，那么这些团队就需要有稳定性。研发团队重新自我设计成为跨职能团队，在同一地方，这些团队长期在一起（除非自然原因，如员工离职）。随着时间推移，团队学会了更多的自管理。但是，这些改进主要发生第二个组织设计实验中，在那个实验中，发生了更多的组织设计变革，更多介绍请参考[下述章节](#2-experiment-2-organizational-design-redesigning-the-feature-teams-and-removing-the-management-layer).
...
根据LeSS指南*理解特性团队*来创建特性团队，意味着围绕客户价值来组建团队，专注于客户领域而非技术领域（技术专长是在以客户为中心过程中的偶然习得的专长）。特性团队是稳定的、长期的团队，具备端到端交付以客户为中心的特性所需的知识与技能。如果并非如此，那么团队被期望去学习获取所需的知识与技能。这并*不意味*着每个团队可以*交付每个特性*。例如，一个较大的特性，被分解为多个以客户为中心的部分（并非组件或技术模块），然后通常由不同的特性团队去完成交付。每个团队有能力交付这样的特性（或者通过学习获取能力来交付）。基于*采用志愿者*的LeSS实施原则，通过自我设计，当前团队被重新组织为特性团队。另一种方式是随着时间推进，不断增加覆盖范围和跨职能能力，比如使用*特性团队实施地图*（LeSS指南）。通过这种方式，团队随着时间慢慢成长为特性团队。研发产品的团队在LeSS实施之初，通过自我设计转变为跨职能的和以客户为中心的团队。他们不断优化，从而让团队具备尽可能多的技能。更多详情，请参考[检查章节](#134-inspection-od-element-less-rule-the-majority-of-the-teams-are-customer-focused-feature-teams)。
...
* *LeSS规则: 产品定义应该基于实际尽可能的宽广和以用户/客户为中心。随着时间推移，产品定义也许会拓展，我们倾向于更宽泛的定义。*
...
在LeSS实施前，“产品”是整个产品的架构组件，每个“产品”都有一个团队聚焦其上，专注于一个具体架构组件。在决定实施LeSS后，在实施前准备的组织改进Kata工作坊中，参与人员共同定义了产品。最初的产品定义是整个产品 - SAFEQ - 包括全部的架构组件，除了基础设施。此外，全部外围职责也被划分到产品定义内，例如技术支持，回归测试和产品发布。这几乎覆盖了全研发部门，因为SAFEQ在当时是公司的主要产品，所以也影响了研发与Y Soft内部绝大多数其他部门的协作。一个足够宽广的产品定义，宽广到无法更加以用户/客户为中心了。 
...
拥有一个“未完成”单元（如Y Soft的测试&发布团队）会延迟增量的实施交付，延迟学习与反馈，并削弱了团队的责任感。因此，“未完成”单元应该被消除。Y Soft内部最关键的“未完成”单元是测试&发布团队。在团队自我设计过程中，测试&发布团队的成员加入了特性团队。团队达成一致，轮流负责创建发布版本（每次发布）和支持工作（每个Sprint）。这个团队就是LeSS指南*处理特殊事项*的快速响应团队，而且是轮换制的，从而实现了全部团队共同承担运维支持职责，并同时保持阶段性专注。
...
这不但消除了瓶颈，还在共享“流程”方面带来了很多改进，如运维支持，问题修复，回归测试和产品发布。为了完成这些“流程”任务，团队需要学习很多技能（而且需要互相教导与帮助），在一年后，大部分团队都可以胜任这些“流程”中的绝大部分任务。此外，团队也做了很多流程改进，因为他们现在要对整个产品负责。有时候这感觉很痛苦，需要付出很多努力，有时还会出现错误，所以影响并不小。但是，团队更好的理解了整个产品，并共同承担责任。
...
许多组织都是围绕职能专业来构建的，如测试、开发、架构和产品营销。因有限的职能视角，这些职能单元的存在会导致局部最优。相反，应该以（跨职能）团队作为组织单位。在Y Soft案例中，在LeSS实施前，研发部是以职能单元构建的，一些（中层）领导负责测试、开发、架构等团队。在LeSS实施的重构中，这些领导转变为（跨职能）团队的负责人。唯一的例外就是安全和架构部门，但架构师们决定（目前暂时）不参与这些团队。安全专家确实加入了团队，但他们也非常积极向没有安全专家的团队传播安全知识，这有效限制了安全方面的局部优化（使得整个组织的安全水平得以提升）。
...
在Scrum中，团队在每轮迭代中都交付完整的以客户为中心的产品待办事项。这对工作的组织方式、以及工作的设计都有很大影响。在这一点上，重要的是要从客户的角度为团队设计更广泛的工作职责。由于采用了*组件团队*的组织结构，Y Soft内部的工作设计主要聚焦于组件，技术和功能。在开始实施LeSS时，工作被重新设计以覆盖以客户为中心的产品待办事项，将（不同*组件*和*功能*）的任务结合在*特性团队*中。
...
我们使用下述组织设计原则来精简适配LeSS组织：

We use the following organizational design principles to descale into LeSS organizations:

1. 从专家角色到团队：团队成为组织构建的基础。随着时间的推移，特定领域的专家（主要是技术领域）在团队内部和外部分享他们的知识，因此团队获得了这些知识，而不在依赖个别专家。

2. 从资源思维到人才思维：组织构建的基础逐渐转变为团队，个人绩效评估转变为团队反馈。尽管组织仍旧期望以完整团队的形式增加“产能”，这表明在一定程度上资源思维仍旧存在，但随着时间的推移，渐渐会转变为更加注重人才的思维。一个人才思维的例子是，CEO发现研发部门的的薪酬低于市场平均水平，于是他大幅提升了研发部门所有员工的薪资，使高于平均水平。

3. 从围绕技术的组织到围绕客户价值的组织：团队转变为特性团队，聚焦以客户为中心的产品待办事项。技术显然也是重要的，但是专业知识在团队内部和团队间分享。

4. 从独立团队到持续跨团队协作：LeSS实施促进了跨团队协作和现状的透明度。在LeSS启动后，有了越来越多的协作，但是真正的和更为持续的协作，需要时间去学习。

5. 从“协调到整合”到“通过整合实现协调”：这的确是个挑战，具体可参考[1.3.6章节](#136-inspection-od-element-less-experiment-tryeliminating-the-undone-unit-by-eliminating-undone-work)。由于团队对全部产品相关的工作负责，因此他们开始不断改进前提条件和行为，从而实现持续的整合。

6. 从项目到产品：对研发来讲，不再有项目的概念，全部工作都来自于一份的产品待办列表。尽管在研发外部，仍旧有一些项目，但这些项目对研发影响有限。有时，产品待办列表中的待办事项源自某些外部项目，如营销领域的项目。

7. 从多个小产品到少数宽泛的大产品：与组件团队聚焦具体组件开发、职能团队关注具体职能工作不同，重新定义的一份产品定义，让多个团队一起工作在同一个产品上。这是从多个小产品转变到一个大产品的良好开始。在这个产品之外，公司还有许多其他小产品，但是这个产品在当时是Y Soft的核心产品。
...
在LeSS实施启动后，新成立的特性团队开始了第一个Sprint的工作。团队开始端到端的交付完整特性。这些特性功能更加以客户为中心（尽管还不完美）。对于组织的其它部分，研发不再是一个黑盒子，因为产品待办事项和团队当前进行工作变得更加透明。Y Soft内部的利益相关者能更好的理解研发内容，并能够更好的在工作中利用这些信息，例如，在与客户沟通中（例如产品营销）。
...
然而，已有痛点的透明化也有不利的一面，这也是团队实施Scrum过程中非常可预见的情况：一些人把这些痛点归咎于新的工作方式和LeSS。 人们需要与他人分享知识（有些人并不喜欢这样）；需要做回归测试，但之前这不是必须的；需要共同进行产品待办事项列表的梳理细化，而之前只是部分人创建需求而已，等等。人们没有努力改进系统，而是互相指责。这杯关注“效率”和“产出”（而非“成果”）的团队经理所强化，他们推动团队快速完成工作，而不是聚焦质量和产品改进。这种推动当然是由历史上的“效率和产出”管理指标和奖金所驱动的，尽管这些指标和奖金已经被取消，但人们还没有因此改变他们的行为。然而，高层管理仍然关注所谓的“速度”，即团队在一个Sprint中所完成的工作量。这种关注最初加剧了这种行为，尽管这并没有与之相关的奖金。后来，当事情逐渐稳定下来，新的产品负责人 (参考 [章节3.2.4](#324-change-of-product-owners))上任后，团队感受到的压力才慢慢减少。
...
总体来说，最初的几个Sprint被描述为“痛苦的”，但它们带来了大量的透明度，为持续改进工作奠定了基础。在外部支持下，产品总监和Scrum Master们持续努力深度优化产品开发过程，这是一段曲折而挑战的旅途。
...
参与者们创建了一个*系统模型*（因果循环图），并识别了一些趋势指标来定期评估所采取的措施是否有助于整体系统改进。这次工作坊提出的主要评估指标包括：
...
工程师、Scrum Master和管理层参加了为期两天的成熟度模型工作坊。这个由不同角色组成的参与者群体定义了Y Soft背景下的“成熟度”含义，并确定了哪些角色和元素与成熟度模型相关。这导致了不同类别的多个成熟度模型：
...
参与者分别为每个类别定义了领域。例如，在“被授权的自驱型团队”这一类别中，参与者定义了如“工程技能水平”和“处理客户反馈”等领域。对于每个领域，他们都描述了五个成熟度级别的定义。例如，“工程技能水平”的第三级被描述为：“通过自行设计交付功能：我们能够自行设计和交付功能。如果团队中包含新手，他们会得到适当的支持（但不会受到持续的监督或检查），并且会为他们制定发展计划。”
...
#### 1.3.5 检查组织设计元素：LeSS规则：产品定义应该基于实际尽可能的宽广和以用户/客户为中心。随着时间推移，产品定义也许会拓展，我们倾向于更宽泛的定义  Inspection OD-element: LeSS rule: The definition of product should be as broad and end-user/customer centric as is practical. Over time, the definition of product might expand. Broader definitions are preferred.
...
产品负责人是产品营销团队的负责人，在组织上隶属于营销部门，不属于研发部门。产品营销团队的大多数成员都与团队紧密合作，类似于LeSS实验([《精益与敏捷开发 - 大型应用实战》](https://www.amazon.com/Practices-Scaling-Lean-Agile-Development/dp/0321636406))中的PO*代表*或*支持*PO。PO代表主要围绕“主题”来组织，这些主题通常是以客户为中心的特性，但也可能围绕某具体供应商的请求或缺陷。PO代表在产品待办事项梳理活动（PBR）中扮演主要角色，在Sprint计划会和Sprint评审会中也发挥着积极作用。他们与团队一起讨论特性的重要性，并帮助团队做置换权衡。然而，PO代表仍然作为一个独立的职能单元，虽然协作有所改善，但团队无法独立完成与产品营销相关的工作，并且总是需要与他们合作才能交付产品。
...
让我们来拆解这个规则，并对Y Soft的（两个）产品定义进行反思。
...
* **‘在实际可行的前提下尽量宽泛’**</br>从整体产品焦点的角度来看，Y Soft可以从[宽泛的产品定义](https://less.works/less/framework/product)中获得以下好处：
    ...
    * **团队根据客户需求和市场机会从一个主题转向另一个主题的适应性**<br/>LeSS的优化目标是能适应不断变化的需求，以能实现最高的客户价值。当团队被限制在一个狭窄定义的产品中时，他们不太可能适应其产品定义之外的工作，因为整个产品视图、对客户和市场的理解以及产品知识都局限在狭窄定义的产品中。如果是一个产品，团队将有更广阔的视野、对客户和市场更广泛的了解，从而也更容易适应其它类型的工作。当然，这仍然需要学习，但与狭窄的产品视角相比，以整个产品视角会更容易。
    ...
    * **工作在全局最高的价值上**<br/>定义成两个产品会在某个时间点导致产品1的价值明显高于产品2。但是，工作在产品2上的团队仍然会挑选产品2的最高价值来做，而不是挑选产品1中更高价值的条目。这意味着从客户和组织的角度来看，我们挑选了潜在价值较少的工作。
    ...
    * **更好的总览和更细粒度的优先级**<br/>选择转向两个产品，公司层面的总览会减少，因为这两个产品有单独的产品待办列表，它们之间也更少对齐。分成两个产品限制了总览，同时例如OMNI系列相对较小，当时只有3个团队在它上面工作。
    ...
    * **避免类似产品之间的重复**<br/>如前所述，Y Soft认为这两个产品是不同的，并预期它们之间几乎没有重复。明显两个产品之间是存在重复的，因为产品需要连接并使用相同的基础设施技术。要考虑的是有多少重复，以及它能否充分支持转向两个产品的选择。良好的设计也能限制产品之间的重复，尤其是作为单个产品来考虑时。
...
其中一个选项是做团队已经在做的事情：团队聚焦在特定领域上。工作在唯一产品待办列表上的其中三个团队在PBR和他们的迭代中重点关注与OMNI系列相关的条目。这样做仍然给予了OMNI系列聚焦，但没有失去在其它时刻切换并专注于产品不同部分的适应性，并在需要时跨团队协作以提高适应性。随着联合创始人成为SAFEQ的产品负责人（见[本节](#324-change-of-product-owners)），愿景和优先级更加清晰，团队能够根据愿景和优先级更多聚焦在某些（客户）领域。如果这发生在讨论和决定转向两个产品之前，决定可能会有所不同，因为这个问题很可能已经得到解决。
...
## 附录B： 为启动LeSS的4天活动所做的准备为期4天LeSS实施启动的准备活动 Appendix B: Preparation to the 4-day events that kicked off the LeSS adoption

### B.1 现场工作坊的远程准备 Remote preparation of on-site workshops

从组织、工作流程和当前代码的技术健康度等不同角度对Y Soft研发情况进行分析，是准备工作的开始。远程准备工作的目标是了解Y Soft的现状，更好地了解Y Soft和Co-Learning（作为LeSS实施的合作伙伴），并共同学习下一步的行动方案。
...
从对 Soft内部工具使用情况着手，开始做分析，比如Confluence，企业内部ERP的打印输出物等，以进行组织评估。此外，还与Y Soft的Scrum Master和产品总监进行了访谈，以获取更多的澄清和理解的确认。组织评估的结果为LeSS实施准备的后续活动提供了指导，例如组织改进Kata现场工作坊，以重新设计组织结构。工作流程的评估也是通过类似的方式进行的，包括分析Y Soft流程工具的Confluence和Jira，并进行访谈以获取更多信息和确认。
...
技术健康度的评估有：
* 结合Git的提交记录，利用gource.io（版本可视化工具）可视化代码项目（git project）的发展过程 （如下图）
* 分析Bamboo的构建计划和部署计划，包括失败情况、成功率、运行时间等。
* 分析现有的分支策略和从git中生成的架构文档。
...
这些技术健康度评估被用于和开发人员一起验证并学习如何改进。例如，开发团队吸取的一个学习点是，曾经只有个别人员具备的知识点（特定组件或技术），要确保在团队自设计过程中能有效传播，从而让全部团队成员都有机会学习到这类知识，减少技能瓶颈。
...
这些结果在研讨会上得到了验证，并作为在四天活动里工作坊的准备工作。
...
### B.3 始组织改进Kata （2018年8月） Initial Organizational Improvement Kata (August 2018)
...
在这次工作坊中，研发、人力资源、产品营销、商业部门的分管VP和部分中层管理者（C-Level）一起探讨了他们当前的组织结构，并与准备阶段所验证的结果相结合。请注意，并没有财务部门的代表出席，这在很多情况下都会有所帮助。因为财务政策通常对组织结构有很大的影响，在转向LeSS时应该重新考虑。参与者们发现了有利的模式和不那么有利的模式，并将它们记录下来进行了讨论。结果如下图所示。
...
一旦范围明确后，该小组继续使用特性团队实施地图（Feature Team Adoption map），去识别对工具使用许可证、不同研发地点的可用硬件等方面的相关需求，以及不同团队和研发地点的在技术能力方面的差异。
...
其他工作坊还包括如何收集需求，验证技术评估结果，以及让领导们理解LeSS原则。事后反思，应该组织一个关于Scrum基础和原则的工作坊或者培训，因为并非所有开发人员都了解这些知识。
...
接下来，我们将需求和准备工作分类放到待办事项列表中，分别标记为“4天活动前必须完成的事项”、“4天活动期间的事项”和“4天活动后的事项”。这个待办列表对应的wiki页面在Y Soft公司内部十分有名，它列出了志愿者们为准备为期4天的LeSS实施启动活动而需要采取的行动。启动活动目标定于2018年11月举行。
...
并没有一个正式的“变革团队”来参与并推进这些步骤，而是由一群（非常多的）志愿者来领导这次变革。然而，不利的一面是志愿者团队成员不固定，有时会人员进出，这使得推动变革更加困难。一小群人 - 主要是Scrum Masters - 主动站出来确保志愿者们能够做正确的事情。人们加入了志愿者团队，但对志愿者的期望是在会议中设定的，而不是事先预定的。
...
准备活动的目标与工作坊的沟通应该做得更多和更好。这样会使志愿者们能够更加清楚期待他们做什么，他们的贡献也会更加聚集有效。
...
一个重要发现是，没有人愿意做重新定义后产品的产品负责人。
An important observation was that nobody wanted to be the Product Owner for the newly defined product.

### B.4 准备为期4天的LeSS启动活动 Preparing the 4-day event starting the LeSS adoption

在Y Soft，由VP和Scrum Master主导4天启动活动的准备。并没有因此专门成立一个变更小组，全部活动组织的职责都由志愿者承担。志愿者们每周同步2次进展，并讨论下一步工作计划。

Within Y Soft, the VP and the Scrum Masters took the lead to further prepare the 4-day event. There was no official change team and the responsibilities for all activities were taken by volunteers. The volunteers met twice a week to synchronize on progress and discuss and plan next steps.

活动之一是成立社区（在那个时候被称为“实践社区”，并且这个术语迄今仍在Y Soft内使用），以便团队之间方便知识分享。LeSS指南*社区*就是为了重点解决跨团队事宜，比如技能、标准、工具和设计。推荐的社区包括设计/架构社区和测试社区，开发人员有时会被要求成立他们认为有用的社区，这会导致过多无实际作用的社区。这些社区“成立”之初，有举办会议，但没有明确的目标，也缺乏相关知识的分享。当Scrum Masters意识到他们没有运营社区的经验时，他们尝试借助外部支持从他人那里获取知识。这最终产出了一份实验清单，列出了人们在运营内部社区时可以尝试或需要避免的实验。
...
有些Y Soft内部社区把社区作为一种控制工作的手段，例如组件相关的工作，对于自管理的团队来说已经不再围绕组件来工作了。安全社区则使团队成员对安全有了深入的认知，并提高了产品的安全质量，Scrum Master认为这是一个成功的社区案例。该社区在每个团队引入了“安全主席”的角色，也就是每个团队的参与安全社区的代表，负责把他们获取到的安全知识传播到各自团队中。到了2021年，只有少数几个社区（测试/质量保证社区、开发实践社区）仍在运行，还在经常分享知识或促进质量提升。让社区持续运作起来的主要经验是，要支持人们以明确的目标去组织和构建社区，并且这个目标在社区成员间要达成共识，同时要有一位对社区运营充满热情、有意愿经营社区的协调人员。
...
为了鼓励人们参与到准备工作中来，Scrum Master们组织了“开放空间”和“精益咖啡”等活动，让人们能够分享进展，并解决他们遇到的困难、恐惧或问题。*开放空间*是LeSS指南所推荐的，用于定期学习和协作，让参与者自组织加入。
